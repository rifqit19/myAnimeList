...
public class Ova extends AppCompatActivity {
    ...
    private String TAG = Ova.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ova);

        back = findViewById(R.id.backA5);
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Ova.this);
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Ova.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Ova.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerOva);
        adapterTopAnime = new adapterTopAnime(this,topAnimeObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Ova.this);
