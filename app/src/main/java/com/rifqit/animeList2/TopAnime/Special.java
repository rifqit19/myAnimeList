...
public class Special extends AppCompatActivity {
    ...
    private String TAG = Special.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Special.this);
        progressDoalog.setMessage("Loading...");
        progressDoalog.show();
        getTop("anime",1,"special");
    }
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Special.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Special.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerSpecial);
        adapterTopAnime = new adapterTopAnime(this,topAnimeObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Special.this);
