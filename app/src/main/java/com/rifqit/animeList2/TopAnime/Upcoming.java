...
public class Upcoming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Upcoming.this);
        progressDoalog.setMessage("Loading...");
        progressDoalog.show();
        getTop("anime",1,"upcoming");
    }
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Upcoming.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Upcoming.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Upcoming.this);
