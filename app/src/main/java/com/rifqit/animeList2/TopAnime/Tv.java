...
public class Tv extends AppCompatActivity {
    ...
    private String TAG = Tv.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Tv.this);
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Tv.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Tv.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Tv.this);
