...
public class DetailRecommendManga extends AppCompatActivity {
    ...
    private String TAG = DetailRecommendManga.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_recommend_manga);

        imgD = findViewById(R.id.imageDrm);
        ttlD = findViewById(R.id.tittleDrm);
        typD = findViewById(R.id.typeDrm);
        memberD = findViewById(R.id.membersDrm);
        episodD = findViewById(R.id.episodesDrm);
        synopD = findViewById(R.id.synopDrm);
        webD = findViewById(R.id.webDrm);
        backk = findViewById(R.id.back2Drm);
        toggleButton = findViewById(R.id.toggleDrm);
        scoreD = findViewById(R.id.scoreDrm);
        progressBar = findViewById(R.id.progressDrm);

        Realm.init(DetailRecommendManga.this);
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    Toast.makeText(DetailRecommendManga.this, "Disimpan ke Favorite!", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    Toast.makeText(DetailRecommendManga.this,"Item dihapus",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void detailReccomend(Integer id){
        progressDialog = new ProgressDialog(DetailRecommendManga.this);
        progressDialog.setMessage("Loading....");
        progressDialog.show();
//        progressBar.setVisibility(View.VISIBLE);
        GetDataService service = RetrofitCilentInstance.getRetrofitInstance().create(GetDataService.class);
        Call<ResponseBody> call = service.getDetailRecomendationManga(id);
...
//                        s.setEpisodes(eps);
                        ...
                        Picasso.with(DetailRecommendManga.this).load(imageUrl1).into(imgD);
...
//                        episodD.setText(eps.toString());
                        ...
                        Toast.makeText(DetailRecommendManga.this, e.getLocalizedMessage()+111, Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
//                progressBar.setVisibility(View.GONE);
                Toast.makeText(DetailRecommendManga.this, t.getLocalizedMessage()+11, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                progressDialog.dismiss();
    ...
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerRecomendDetailDrm);
        adapterRecommndation = new AdapterRecommendationManga(DetailRecommendManga.this,recommObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DetailRecommendManga.this,LinearLayoutManager.HORIZONTAL, false);
