...
public class OneShots extends AppCompatActivity {

    private String TAG = OneShots.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_shots);

        back = findViewById(R.id.backT3);
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(OneShots.this);
        progressDoalog.setMessage("Loading...");
        progressDoalog.show();
        getTop("manga",1,"oneshots");
    }
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(OneShots.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(OneShots.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerOneshots);
        adapterTopManga = new AdapterTopManga(OneShots.this,topMangaObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(OneShots.this);
