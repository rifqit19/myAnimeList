...
public class Manga extends AppCompatActivity {
    ...
    private String TAG = Manga.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Manga.this);
        progressDoalog.setMessage("Loading...");
        progressDoalog.show();
        getTop("manga",1,"manga");
    }
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Manga.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Manga.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerManga);
        adapterTopManga = new AdapterTopManga(Manga.this,topMangaObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Manga.this);
