...
public class Menhwa extends AppCompatActivity {

    private String TAG = Menhwa.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menhwa);

        back = findViewById(R.id.backT5);
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Menhwa.this);
        progressDoalog.setMessage("Loading...");
        progressDoalog.show();
        getTop("manga",1,"manhwa");
    }
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Menhwa.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Menhwa.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerMenhwa);
        adapterTopManga = new AdapterTopManga(Menhwa.this,topMangaObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Menhwa.this);
