...
public class Novel extends AppCompatActivity {
    ...
    private String TAG = Novel.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generateDataList();
        progressDoalog = new ProgressDialog(Novel.this);
        progressDoalog.setMessage("Loading...");
        progressDoalog.show();
        getTop("manga",1,"novels");
    }
...
//                        swipe.setRefreshing(false);
                        ...
                        Toast.makeText(Novel.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(Novel.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void generateDataList() {
        recyclerView = findViewById(R.id.recyclerNovel);
        adapterTopManga = new AdapterTopManga(Novel.this,topMangaObjs);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Novel.this);
